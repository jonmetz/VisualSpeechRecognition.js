...
We found VSR to be a worthy problem for a couple of reasons. The effectiveness of audio based speech recognition depends on the absence of background noise, so a vision based or hybrid system would be more accurate in these situations \cite{Dupont}.
A VSR system can also be useful in scenarios where only visual data is kept, such as in Closed Circuit TV recordings.

!!FINISH!! It is difficult because
...
example~\cite{Dupont}.  Where appropriate, include the name(s) of
